...
public final class Reference {
    ...
    public static class UnlocalizedName {
        ...
        public static final class Block {
            ...
            public static final String LARGE_FERMENT_BARREL_ACACIA = "large_fermentation_barrel_acacia";
            public static final String LARGE_FERMENT_BARREL_APPLE = "large_fermentation_barrel_apple";
            public static final String LARGE_FERMENT_BARREL_BAMBOO = "large_fermentation_barrel_bamboo";
            public static final String LARGE_FERMENT_BARREL_BIRCH = "large_fermentation_barrel_birch";
            public static final String LARGE_FERMENT_BARREL_CHERRY = "large_fermentation_barrel_cherry";
            public static final String LARGE_FERMENT_BARREL_CRIMSON = "large_fermentation_barrel_crimson";
            public static final String LARGE_FERMENT_BARREL_DARK_OAK = "large_fermentation_barrel_dark_oak";
            public static final String LARGE_FERMENT_BARREL_JUNGLE = "large_fermentation_barrel_jungle";
            public static final String LARGE_FERMENT_BARREL_MANGROVE = "large_fermentation_barrel_mangrove";
            public static final String LARGE_FERMENT_BARREL_OAK = "large_fermentation_barrel_oak";
            public static final String LARGE_FERMENT_BARREL_PALE_OAK = "large_fermentation_barrel_pale_oak";
            public static final String LARGE_FERMENT_BARREL_SPRUCE = "large_fermentation_barrel_spruce";
            public static final String LARGE_FERMENT_BARREL_WARPED = "large_fermentation_barrel_warped";
            public static final String LARGE_STORAGE_BARREL_ACACIA = "large_storage_barrel_acacia";
            public static final String LARGE_STORAGE_BARREL_APPLE = "large_storage_barrel_apple";
            public static final String LARGE_STORAGE_BARREL_BAMBOO = "large_storage_barrel_bamboo";
            public static final String LARGE_STORAGE_BARREL_BIRCH = "large_storage_barrel_birch";
            public static final String LARGE_STORAGE_BARREL_CHERRY = "large_storage_barrel_cherry";
            public static final String LARGE_STORAGE_BARREL_CRIMSON = "large_storage_barrel_crimson";
            public static final String LARGE_STORAGE_BARREL_DARK_OAK = "large_storage_barrel_dark_oak";
            public static final String LARGE_STORAGE_BARREL_JUNGLE = "large_storage_barrel_jungle";
            public static final String LARGE_STORAGE_BARREL_MANGROVE = "large_storage_barrel_mangrove";
            public static final String LARGE_STORAGE_BARREL_OAK = "large_storage_barrel_oak";
            public static final String LARGE_STORAGE_BARREL_PALE_OAK = "large_storage_barrel_pale_oak";
            public static final String LARGE_STORAGE_BARREL_SPRUCE = "large_storage_barrel_spruce";
            public static final String LARGE_STORAGE_BARREL_WARPED = "large_storage_barrel_warped";
