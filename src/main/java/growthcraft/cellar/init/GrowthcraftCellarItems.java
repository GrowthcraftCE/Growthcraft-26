...
public class GrowthcraftCellarItems {
    ...
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_ACACIA = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_ACACIA, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_ACACIA);
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_APPLE = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_APPLE, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_APPLE);
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_BAMBOO = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_BAMBOO, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_BAMBOO);
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_BIRCH = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_BIRCH, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_BIRCH);
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_CHERRY = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_CHERRY, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_CHERRY);
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_CRIMSON = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_CRIMSON, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_CRIMSON);
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_DARK_OAK = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_DARK_OAK, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_DARK_OAK);
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_JUNGLE = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_JUNGLE, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_JUNGLE);
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_MANGROVE = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_MANGROVE, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_MANGROVE);
    ...
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_PALE_OAK = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_PALE_OAK, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_PALE_OAK);
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_SPRUCE = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_SPRUCE, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_SPRUCE);
    public static final DeferredItem<Item> LARGE_FERMENTATION_BARREL_WARPED = blockItem(Reference.UnlocalizedName.Block.LARGE_FERMENT_BARREL_WARPED, GrowthcraftCellarBlocks.LARGE_FERMENTATION_BARREL_WARPED);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_ACACIA = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_ACACIA, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_ACACIA);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_APPLE = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_APPLE, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_APPLE);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_BAMBOO = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_BAMBOO, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_BAMBOO);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_BIRCH = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_BIRCH, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_BIRCH);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_CHERRY = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_CHERRY, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_CHERRY);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_CRIMSON = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_CRIMSON, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_CRIMSON);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_DARK_OAK = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_DARK_OAK, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_DARK_OAK);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_JUNGLE = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_JUNGLE, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_JUNGLE);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_MANGROVE = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_MANGROVE, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_MANGROVE);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_OAK = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_OAK, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_OAK);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_PALE_OAK = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_PALE_OAK, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_PALE_OAK);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_SPRUCE = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_SPRUCE, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_SPRUCE);
    public static final DeferredItem<Item> LARGE_STORAGE_BARREL_WARPED = blockItem(Reference.UnlocalizedName.Block.LARGE_STORAGE_BARREL_WARPED, GrowthcraftCellarBlocks.LARGE_STORAGE_BARREL_WARPED);
